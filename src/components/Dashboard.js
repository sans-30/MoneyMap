...
const Dashboard = () => {
  ...
  const cardStyle = {
    //boxShadow: "0px 0px 30px 8px rgba(87, 87, 87, 0.75)",
    margin: "2rem",
    borderRadius: "0.5rem",
    minWidth: "300px",
    flex: 1,
  ...
  return (
    <div className={`dashboard-container ${theme}`}>
      <Header />
      <button onClick={toggleTheme} className="theme-toggle-button btn-toggle">
      <FaToggleOff />
      </button>
      {loading ? (
        <Loader />
        ...
        <>
          ...
          <TransactionSearch
            ...
            deleteTransaction={deleteTransaction} // Pass deleteTransaction function
          />
        </>
      )}
    </div>
